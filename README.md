...
<img src="./src/assets/images/logo-complete.png" width="100%"/>
...
Este proyecto consiste en el desarrollo de la página web de [Enamino](https://www.enamino.com), un campamento ubicado en el parque nacional de Loango - Gabón, África. Se trata de un trabajo freelance
cuyo objetivo es proporcionar a los clientes información detallada sobre el campamento, como alojamiento, menú, actividades, información para el viaje, ubicación y demás información. Además se
muestran diferentes aspectos relacionados a Gabón y el parque nacional de Loango.
...
-   Implementación de elementos de diseño como íconos con la librería de [react-icons].
-   Utilización de la librería [react-google-maps](https://visgl.github.io/react-google-maps/) para renderizar un componente con un mapa interactivo, donde se muestra la ubicación del local y
...
-   Incorporación de elementos multimedia como imagenes, video y audio.
...
1. Clone este repositorio en tu máquina local con el comando:
    ```bash
    git clone https://github.com/Gaston-Valentini/enamino.git
    ```
...
Me gustaría agradecer a todo el equipo de Enamino por hacer posible esta colaboración.

[Volver al inicio](#enamino---sitio-web)
